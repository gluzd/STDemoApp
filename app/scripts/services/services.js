...
angular.module('STDemoApp.services', [])
    ...
    .factory('BookService', function($http) {
        ...
        return {
            all: function(callback) {
                $http.get('assets/data/notifications.json').success(
                    function(data) {
                        books = data;
                        callback(data);
                    }
    ...
    .factory('MediaService', function() {
        ...
        var media = [
            { id: 0, title: 'Lena Team 1', description: 'Lena Team Description' },
            { id: 1, title: 'March Creek', description: 'March Creek Descriptio' },
            { id: 2, title: 'Alaghe NY', description: 'Alaghe NY' },
            { id: 3, title: 'Cats1', description: 'Cats1 Description' },
        ];
